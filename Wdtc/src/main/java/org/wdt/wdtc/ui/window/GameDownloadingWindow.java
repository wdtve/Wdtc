...
public class GameDownloadingWindow {
  private final Launcher launcher;

  public GameDownloadingWindow(Launcher launcher) {
  ...
  public void setDownGameWin(Stage MainStage) {
    ...
    textField.setText(launcher.getVersionNumber() + "开始下载,下载源: " + DownloadSourceManger.getDownloadSourceKind());
