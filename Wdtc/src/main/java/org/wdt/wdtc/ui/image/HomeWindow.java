...
import org.wdt.wdtc.ui.image.users.NewUserWindows;
...
public class HomeWindow {
    ...
    public void setHome(Stage MainStage) {
        ...
        startgame.setOnAction(event -> {
            VersionChoose choose = new VersionChoose(Objects.requireNonNullElseGet(launcher, GameDirectoryManger::new));
                ...
                if (User.isExistUserJsonFile()) {
                    ThreadUtils.startThread(() -> {
                        try {
                            ...
                            launchProcess.setSetUIText(string -> ErrorWindow.setWin(string, "Launch Error"));
