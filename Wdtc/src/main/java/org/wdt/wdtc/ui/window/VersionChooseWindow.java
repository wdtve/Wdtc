...
public class VersionChooseWindow {
    private final GameDirectoryManger path;

    public VersionChooseWindow(GameDirectoryManger path) {
        this.path = path;
    }
    ...
    public void setWindow(Stage MainStage) {
        ...
        NewGame.setOnAction(event -> GameVersionListWindow.setWindowScene(MainStage));
    }
