...
public class SettingWindow extends SettingManger {
    ...
    public static void setSettingWin(Stage MainStage) throws IOException {
        ...
        OfficialDownloadSource.setOnAction(event -> {
            ...
            setting.setDownloadSource(DownloadSourceManger.DownloadSourceList.OFFICIAL);
            putSettingToFile(setting);
        });
        BmclDownloadSource.setOnAction(event -> {
            ...
            setting.setDownloadSource(DownloadSourceManger.DownloadSourceList.BMCLAPI);
            putSettingToFile(setting);
        });
        McbbsDownloadSource.setOnAction(event -> {
            ...
            setting.setDownloadSource(DownloadSourceManger.DownloadSourceList.MCBBS);
            putSettingToFile(setting);
        });
