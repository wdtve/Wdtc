...
data class Setting(
  ...
  var preferredVersion: Launcher? = null
)


val setting: Setting = settingFile.readFileToClass(serializeLauncherGson)

fun Setting.putSettingToFile() = settingFile.writeObjectToFile(this, serializeLauncherGson)